  ...
  return (
    <div className='footer absolute bottom-2 left-1/2 transform -translate-x-1/2 w-fit'>
      <div className="flex justify-center items-center gap-5 p-3">
        <img className='icon icon transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] github' src="/github.svg" alt="GitHub" />
        <img className='icon icon transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] note' src="note.svg" alt="Notes" />
        <img className='icon icon transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] pdf' src="pdf.svg" alt="PDF" />
        ...
        <img className='icon icon transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] spotify' src="spotify.svg" alt="Spotify" />
        ...
        <img className='icon icon transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] cli' src="cli.svg" alt="Terminal" />
      </div>
    </div>
  )
}
